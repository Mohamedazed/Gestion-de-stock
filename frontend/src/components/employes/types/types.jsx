          ...
          <tbody>
            <tr className='bg-light'>
             <td  className='d-flex justify-content-between bg-light '>
                ...
                {/* Name: <br/><div class="input-group flex-nowrap"><span class="input-group-text" id="addon-wrapping">@</span><input type="text" name="name" value={searchParams.name} class="form-control" onChange={handleChange} className='border rounded m-2' /></div>
