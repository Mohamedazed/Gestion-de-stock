...
const openEditModal = () => {
  ...
  return (
    <div className="container">
      ...
      <div className="border d-flex shadow bg-light mt-4" style={{ overflowX: 'auto' }}>
    ...
    <div className="border mt-5 p-3 shadow bg-light" style={{ overflowX: 'auto' }}>
  <div className="">
  <div className="d-flex justify-content-between align-items-center">
      <h4>Personal Details</h4>
      <button onClick={handleEdit} className='btn bg-warning-subtle'>
  ...
  <div style={{marginLeft : '130px'}}>
    ...
    <p ><span className='text-secondary me-2'>Email ID</span> {admin.email}</p>
      ...
      {isEdItModalOpen && (
                <>
                {/* <EditModalProfil isOpen={openEditModal} onClose={closeEditModal} values={values} setValues={setValues} handleChange={handleChang} handleSubmit={handlSubmit} /> */}
                <EditModalProfil isOpen={openEditModal} onClose={closeEditModal} values={admin} setValues={setAdmin} handleChange={handleChange} handleSubmit={handleSubmit} />
                </>
            )}
    </div>
  );
