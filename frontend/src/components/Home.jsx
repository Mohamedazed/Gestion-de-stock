...
//         <div className='col-sm saveT border border-warning-subtle rounded-4 w-50' style={{overflowX: 'auto'}}>
...
//             </table>
//         </div>
//         <div className='col-sm saveT border border-warning-subtle rounded-4 container d-flex align-items-center ' style={{height:'340px'}}>
//           <canvas id="salesPurchasesChart" width="200" height="200" className='d-flex align-items-center ms-4 mb-2'></canvas>
//         </div>
//         <div className='row'>
//         <div className='col-sm saveT w-100 border border-warning-subtle rounded-4' style={{ overflowX: 'auto',height:'370px' }}>
...
//         <h5 className='text-secondary mt-2'><b>Daily Revenue (DH)</b></h5>
                ...
                <th colSpan='3' className='d-flex justify-content-between'>
                  ...
                  <div className="dropdown d-inline-block ">
                    ...
                    <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
                      {months.map(month => (
                        <a key={month}>
                          <button className="dropdown-item" onClick={() => setSelectedMonth(month)}>
                            {monthNames[month - 1]}
                          </button>
                        </a>
                      ))}
              ...
              {topSellingProducts.map((product, index) => (
                <tr key={product.product_id} style={{ borderRight: index !== topSellingProducts.length - 1 ? '1px solid #FFF8DC' : 'none' }}>
                  <div className='d-flex align-items-center '>
                    <img src={`http://localhost:8081/${product.product_image.replace(/\\/g, '/')}`} className='rounded-5' alt={product.product_id} width='100px' height='100px' />
                  </div>
                  <div className='d-flex align-items-center'>{product.name}</div>
                  <div className='d-flex align-items-center'><h2>{product.totalQuantity}</h2><p>Qte</p></div>
                </tr>
