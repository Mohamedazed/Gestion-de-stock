...
const ShowProdMod = ({ isOpen, onClose, product }) => {
        ...
        <div className="modal-content">
          ...
          <div className="modal-body ">
            ...
            <div className='text-center'>
              <div className='border border-warning d-inline-block rounded-5'>
                <img src={`http://localhost:8081/${product.Product_Image.replace(/\\/g, '/')}`} className='rounded-5' alt="Product" height='200px' />
              </div>
            </div>
          ...
          {/* Modal footer */}
          <div className="modal-footer border border-warning">
