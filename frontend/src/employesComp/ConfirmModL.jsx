...
const ConfirmModL = ({ isOpen, onClose, onConfirm }) => {
  return (
      ...
      <Modal.Body className="space-y-3 modal-dialog modal-dialog-centered " role="document" >
        ...
        <Modal.Content className="modal-body" >
          <Typography variant="div" className='text-center'>
            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" className="bi bi-exclamation-triangle-fill mb-2 text-warning" viewBox="0 0 16 16">
        ...
        <Modal.Footer className="modal-footer">
          ...
          <Button onClick={onConfirm} size="sm" color="primary" className='btn btn-warning rounded-pill'>
            Logout
          </Button>
        </Modal.Footer>
      </Modal.Body>
